...
- Scenario-facing automation commands are best-effort and should prefer null/current-state/no-op results over aborting for unavailable targets or unusable inputs. Low-level COM/WinRT implementation failures may still surface when no meaningful best-effort result exists.
